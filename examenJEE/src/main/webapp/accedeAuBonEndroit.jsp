...
<body>
  ...
  <div style="visibility:visible;position:absolute;top:200px;left:27%;width:600px;z-index: 1000;padding:60px;background-color: white;
border-style: solid;border-radius: 10px;">
<h1 style="color: rgb(67, 143, 143);">Veuillez sélectionner le type qui correspend à votre compte</h1>
<div class="text-center text-lg-start mt-4 pt-2">
