    ...
    <div class="row height d-flex justify-content-center align-items-center">
      ...
      <div class="col-md-8">
        ...
        <div class="search">
          ...
          <input type="text" class="form-control" name="rechercheAdmin" placeholder="recherche par mail"> 
          <button class="btn btn-primary" type="submit" name="action" value="Recherche Admin">Recherche</button>
...
<c:forEach var="c" items="${listeAdmin}" >
  <tr>
      ...
      <td ><c:out value="${c.getPassword()}"/></td>
       ...
       <td><form action="Admin" method="post">
		   <input type="submit" name="action" class="btn btn-mini btn-danger" value="Supprimer Admin" id="button-15"/>
...
<div>
<h1 style="color: rgb(67, 143, 143);">Ajouter Admin</h1>
<br/>
<form action="Admin" method="post">
	...
	<input type="submit"  class="btn btn-primary" name="action" value="Ajouter Admin" id="button-11"/>
  </form>
</div>
