...
<button  style="margin-left: 85%" class="btn btn-mini btn-info" name="action" id="formButton"  onclick="myFunction('1')" id="button-14">Ajouter type</button>
<div id="1"style="visibility:hidden;position:absolute;top:200px;left:35%;z-index: 1000;padding:60px;background-color: white;
border-style: solid;border-radius: 10px;%">
<div>
<h1 style="color: rgb(67, 143, 143);">Ajouter Type</h1>
<br/>
<form action="Admin" method="post">
    <div class="form-group">
      <label for="exampleInputEmail1">Type</label>
      <input type="text" class="form-control" name="typeRec" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ajouter type reclamation">
    </div>
    
	<input type="submit"  class="btn btn-primary" name="action" value="Ajouter Type" id="button-11"/>
  </form>
</div>
